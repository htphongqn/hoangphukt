<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="chi-tiet-khach-hang.aspx.cs" Inherits="Appketoan.Pages.chi_tiet_khach_hang" %>
                            ...
                            <ContentCollection>
                                <dx:ContentControl ID="ContentControl1" runat="server" SupportsDisabledAttribute="True">
                                    <table width="100%" border="0" cellspacing="1" cellpadding="3">
                                        ...
                                        <tr>
                                            <td class="td_left" align="right" valign="top" nowrap="nowrap">
                                                <span style="color: Red;"></span>&nbsp;Chứng minh nhân dân
                                            </td>
                                            <td align="left" nowrap="nowrap">
                                                <asp:TextBox ID="Txtcmnd" runat="server" class="text" CssClass="k-textbox textbox"></asp:TextBox>
                                                <cc1:AutoCompleteExtender ServiceMethod="SearchCMND" 
                                                    MinimumPrefixLength="1"
                                                    CompletionInterval="100" EnableCaching="false" CompletionSetCount="10" 
                                                    TargetControlID="Txtcmnd"
                                        ...
                                        <tr>
                                            ...
                                            <td align="left" nowrap="nowrap">
                                                <asp:RadioButtonList
                                                    ID="rdblType" runat="server" RepeatColumns="3">
                                                    <asp:ListItem Selected="True" Value="1">Khách hàng tốt</asp:ListItem>
                                                    <asp:ListItem Value="2">Khách hàng xử lý</asp:ListItem>
                                                    <asp:ListItem Value="3">Khách hàng xấu</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </td>
                                        </tr>
                                    </table>
