<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true"
    CodeBehind="danh-sach-hop-dong-xoa.aspx.cs" Inherits="Appketoan.Pages.danh_sach_hop_dong_xoa" %>
    ...
    <div id="header">
        ...
        <div class="toolbar" style="margin-left: 1006px; margin-top: -38px;">
            &nbsp;<%--<a href="chi-tiet-hop-dong.aspx" title="Thêm hợp đồng" class="k-button"><span
                ...
                <asp:LinkButton ID="lbtnRestore" OnClientClick="return confirm('Bạn có muốn khôi phục không ?');"
                    ToolTip="Khôi phục" CssClass="k-button" runat="server" OnClick="lbtnRestore_Click"><img alt="Khôi phục" src="../Images/restore.jpg" /></asp:LinkButton> &nbsp;
            ...
            <td>
                <dx:ASPxGridView ID="ASPxGridView_contract" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Tiền đầu" FieldName="CONT_WEEK_PRICE">
                            <PropertiesTextEdit DisplayFormatString="{0:0,0 VNĐ}" />
                        </dx:GridViewDataTextColumn>
