<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="doanh-so-nhan-vien.aspx.cs" Inherits="Appketoan.Pages.doanh_so_nhan_vien" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHMain" runat="server">
    ...
    <table width="100%" cellpadding="3" cellspacing="3" style="background-color: #f4f4f4;
        ...
        <tr>
            ...
            <td>
            <strong><asp:Label ID="lbBanhang" runat="server"></asp:Label></strong> 
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
             <strong><asp:Label ID="lbXacminh" runat="server"></asp:Label></strong> 
            </td>
        </tr>
        <tr>
            ...
            <td>
             <strong><asp:Label ID="lbGiaohang" runat="server"></asp:Label></strong> 
            </td>
        </tr>
        <tr>
            <td style="width:150px">
            ...
            <td>
             <strong><asp:Label ID="lbThungan" runat="server"></asp:Label></strong> 
            </td>
        </tr>
    </table>
