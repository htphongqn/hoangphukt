<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="danh-sach-cong-ty.aspx.cs" Inherits="Appketoan.Pages.danh_sach_cong_ty" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHMain" runat="server">
    ...
    <table width="100%" cellpadding="3" cellspacing="3" style="background-color: #f4f4f4;
        ...
        <tr>
            <td>
                <dx:ASPxGridView ID="ASPxGridView1_COMPANY" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Tên công ty" FieldName="COM_NAME">
                            <DataItemTemplate>
                            <a href="<%# getlink(Eval("ID")) %>">
                                    <%# Eval("COM_NAME")%></a>
                            </DataItemTemplate>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Số điện thoại" FieldName="COM_PHONE">
                            <DataItemTemplate>
                                <%# Eval("COM_PHONE")%>
                            </DataItemTemplate>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Địa chỉ" FieldName="COM_ADDRESS">
                            <DataItemTemplate>
                                <%# Eval("COM_ADDRESS")%>
                            </DataItemTemplate>
                        </dx:GridViewDataTextColumn>  
